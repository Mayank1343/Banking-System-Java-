...
public class signUpThree extends JFrame implements ActionListener {
    ...
    signUpThree(String formno){ //constructor formation, same name as class
         this.formno = formno;

        setLayout(null); //to use setBounds settings

        setTitle("NEW ACCOUNT TYPE - PAGE 3");
        ...
        JLabel number= new JLabel("XXXX-XXXX-XXXX-1343");
